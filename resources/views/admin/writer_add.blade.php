                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Writer</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="writer[name]" class="form-control" id="writerName"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="writer[finished_papers]" class="form-control"
                                id="writerFinishedPapers" placeholder="Total number of finished papers">
                        </div>

                        <div class="form-group">
                            <label class="form-control-label" for="writerCustomerReviews">Writer customer
                                reviews</label>
                            <input type="number" name="writer[customer_reviews]" class="form-control"
                                id="writerCustomerReviews" placeholder="Total number of customer reviews">
                        </div>

                        <div class="form-group">
                            <label class="form-control-label" for="writerGlobalRatingRank">Writer global rating
                                rank</label>
                            <input type="number" name="writer[global_rating_rank]" class="form-control"
                                id="writerGlobalRatingRank" placeholder="Global rating rank">
                        </div>

                        <div class="form-group">
                            <label class="form-control-label" for="writerRatingScore">Rating score</label>
                            <input type="number" name="writer[rating_score]" class="form-control" id="writerRatingScore"
                                placeholder="Rating score">
                        </div>

                        <div class="form-group">
                            <label class="form-control-label" for="writerSuccessRate">Success rate</label>
                            <input type="number" name="writer[success_rate]" class="form-control" id="writerSuccessRate"
                                placeholder="Success rate">
                        </div>

                        <div class="form-group">
                            <label class="form-control-label" for="writerCost">Cost</label>
                            <input type="number" name="writer[cost]" class="form-control" id="writerCost"
                                placeholder="Cost">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="writer_file" id="writerImage"
                                    lang="en">
