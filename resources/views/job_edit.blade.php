                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="job[document_type]" readonly required>
                                            ...
                                            <option {{ $job->document_type == $item ? 'selected' : ''}}
                                                value="{{$item}}">
                                                {{$item}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="job[academic_level]" readonly required>
                                            ...
                                            <option {{ $job->academic_level == $item ? 'selected' : '' }}
                                                value="{{$item}}">
                                                {{$item}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="job[pages]" value="{{$job->pages}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="job[topic]" placeholder="Write about…"
                                            readonly required>{{$job->topic}}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Self Uploaded Files :</label>
                                        <ul class="list-group">
                                            @php
                                            $demo_file = 0
                                            @endphp
                                            ...
                                            @if ($file->added_by == Auth::id())
                                            <li class="list-group-item d-flex justify-content-between">File
                                                {{$file->id}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            @if ($job->job_files->count() > 0)
                                            @foreach ($job->job_files as $file)
                                            @if ($file->is_demo && $file->added_by != Auth::id())
                                            <li class="list-group-item d-flex justify-content-between">File
                                                {{$file->id}}
                                                <a class="btn btn-link ml-auto" data-fancybox data-type="iframe"
                                                    data-src="{{asset('storage/'.$file->file.'#toolbar=0')}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Revision note" class="form-control" id="" cols="30"
                                            rows="5" readonly>{{$job->revision_note}}</textarea>
                                    </div>
                                    @endif
                                </div>
                            </div>
